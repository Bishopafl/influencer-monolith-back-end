...
Route::group([
    ...
    Route::apiResource('orders', 'OrderController')->only('index', 'show'); // only uses index and show route
    Route::apiResource('permissions', 'PermissionController')->only('index'); // only uses index and show route
});
